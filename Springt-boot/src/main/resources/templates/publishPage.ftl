			          ...
			          <div   style=" margin-top: 20px;   ">
			            <form id="editPublishdataForm"> 
			             ...
			             <i class="fa fa-align-justify" aria-hidden="true"></i>
						   <input id="publishTitle" class="contentTitle" value="${blogContent.postTitle}"   autofocus name="title" type="text"   placeholder="标题:" required data-validation-required-message="必填"  aria-describedby="sizing-addon1"> 
